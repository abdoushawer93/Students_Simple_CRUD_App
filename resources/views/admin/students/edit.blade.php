            ...
            <div class="col-lg-12">
                ...
                <form action="{{route('students.update',$student)}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" value="{{$student->email}}" name="email" aria-describedby="emailHelp" placeholder="Enter email">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label>
                        <input type="password" class="form-control" id="exampleInputPassword1" value="{{$student->password}}" name="password" placeholder="Password">
                    </div>
